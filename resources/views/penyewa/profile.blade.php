                    ...
                    <div class="card-body pt-0 pb-4">
                        <div class="profile-avatar-wrapper">
                            ...
                            @if($profile->foto_profile)
                                <img src="{{ Storage::disk('s3')->url($profile->foto_profile) }}" alt="Profile Picture" class="profile-avatar">
                            @else
                                <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=0D8ABC&color=fff" alt="Default Avatar" class="profile-avatar">
                            @endif
                        </div>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="nama_lengkap" class="form-control form-control-lg @error('nama_lengkap') is-invalid @enderror" 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="no_hp" class="form-control form-control-lg @error('no_hp') is-invalid @enderror" 
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label text-muted small fw-bold">Tempat, Tanggal Lahir</label>
                                        <input type="text" name="tempat_tanggal_lahir" class="form-control form-control-lg" 
                                               value="{{ old('tempat_tanggal_lahir', $profile->tempat_tanggal_lahir) }}" placeholder="Jakarta, 1 Januari 2000">
                                    </div>
                                    ...
                                    <div class="col-12 mt-4">
                                        <div class="p-3 border rounded bg-light">
                                            ...
                                            <p class="text-muted small mb-3">Wajib diisi untuk verifikasi identitas sebelum booking kamar.</p>
                                            
                                            <div class="d-flex align-items-center gap-3">
                                                <input type="file" name="foto_ktp" class="form-control">
                                                @if($profile->foto_ktp)
                                                    <a href="{{ Storage::disk('s3')->url($profile->foto_ktp) }}" target="_blank" class="btn btn-sm btn-outline-info text-nowrap">
                                                        <i class="fas fa-eye"></i> Lihat KTP
                                                    </a>
                                                @endif
                                            </div>
                                            @error('foto_ktp') <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="v-pills-password" role="tabpanel">
                        <div class="profile-card bg-white p-4 p-lg-5">
                            ...
                            <!-- FORM UPDATE PASSWORD (Laravels Default Route) -->
                            <form method="post" action="{{ route('password.update') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="current_password" class="form-control form-control-lg @error('current_password', 'updatePassword') is-invalid @enderror">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="password" class="form-control form-control-lg @error('password', 'updatePassword') is-invalid @enderror">
